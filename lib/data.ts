...
export const demoStore = {
  ...
  banner: "متجر ماتشا فاخر — Powered by Freemen",
  products: [
...
export const adminStores = [
  { name: "Swan Matcha", owner: "مشعل", plan: "Business", status: "موثق", sales: "12,450 ر.س", risk: "منخفض" },
  { name: "Lamya Studio", owner: "لمياء", plan: "Pro", status: "جديد", sales: "2,190 ر.س", risk: "متوسط" },
  { name: "Maramade", owner: "مرام", plan: "Free", status: "مراجعة", sales: "840 ر.س", risk: "مرتفع" },
];
